            ...
            <nav class="navbar navbar-expand-lg main-navbar">
                ...
                <div class="nav-collapse">
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item active"><a href="ttcrpeminjaman.php" class="nav-link">Tata Cara Peminjaman</a>
                    </li>
                    </ul>
                </div>
            ...
            <nav class="navbar navbar-secondary navbar-expand-lg">
                <div class="container">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item ">
                            <a href="#" onclick="tampilkanKonfirmasi()" class="nav-link"><i class="fas fa-list"></i><span>Book
                                    List</span></a>
                        </li>
                        <li class="nav-item ">
                            <a href="#" onclick="tampilkanKonfirmasi()" class="nav-link"><i class="fas fa-book"></i><span>Bookmark</span></a>
                        </li>
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="nav-item"><a href="#" onclick="tampilkanKonfirmasi()" class="nav-link">Riwayat</a></li>
                            </ul>
                        </li>
                    </ul>
                </div>
            ...
            <div class="main-content">
                ...
                ?>
                        ...
                        <div class="pagination justify-content-center mt-4">
                            ...
                            <a class="btn btn-primary <?php if ($current_page == $i) echo 'active'; ?>"
                                href="home.php?page=<?= $i ?>"><?= $i ?></a>
                            <?php endfor; ?>
