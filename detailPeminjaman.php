    ...
    <section class="section">
        <div class="section-header">
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item"><a href="dipinjam.php">Peminjaman</a></div>
                ...
                <div class="card card-primary shadow">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <center>
                                    <img alt="image" height="200" src="assets/img/user/<?= $gambarUser ?>" class="rounded-circle profile-widget-picture mb-3">
                                </center>
                                <div>
                                    <table class="table">
                                        <tr>
