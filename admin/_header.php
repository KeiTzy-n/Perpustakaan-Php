            ...
            <nav class="navbar navbar-expand-lg main-navbar">
                ...
                <ul class="navbar-nav navbar-right">
                    ...
                    <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
                            <img alt="image" src="<?= base_url('assets/img/user/') ?><?= $gambar ?>" class="rounded-circle mr-1">
                            <div class="d-sm-none d-lg-inline-block">Hi, <?= $username ?></div>
                        </a>
                        <div class="dropdown-menu dropdown-menu-right">
                            <a href="<?= base_url('admin/profil.php') ?>" class="dropdown-item has-icon">
            ...
            <div class="main-sidebar sidebar-style-2">
                <aside id="sidebar-wrapper">
                    <div class="sidebar-brand">
                        <a href="<?= base_url('admin/index.php') ?>">MyBooks</a>
                    </div>
                    <ul class="sidebar-menu">
                        ...
                        <li>
                            <a class="nav-link" href="<?= base_url('admin/book.php') ?>"><i class="fas fa-book"></i>
                                <span>Books</span></a>
                        </li>
                        <li>
                            <a class="nav-link" href="<?= base_url('admin/kategori.php') ?>"><i class="fas fa-list"></i>
                                <span>Category</span></a>
                        </li>
                        <li>
                            <a class="nav-link" href="<?= base_url('admin/reader.php') ?>"><i class="fas fa-users"></i>
                                <span>Reader</span></a>
                        </li>
                        <li>
                            <a class="nav-link" href="<?= base_url('admin/staff.php') ?>"><i class="fas fa-users"></i>
                                <span>Staff</span></a>
                        </li>
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li>
                                    <a class="nav-link" href="<?= base_url('admin/peminjaman.php') ?>">
                                        <span>Peminjaman</span></a>
                                </li>
                                <li>
                                    <a class="nav-link" href="<?= base_url('admin/pengembalian.php') ?>">
                                        <span>Pengembalian</span></a>
                                </li>
                                <li>
                                    <a class="nav-link" href="<?= base_url('admin/success.php') ?>">
                ...
                function markAllAsRead(event) {
                    ...
                    xhr.open('POST', '<?= base_url('admin/mark_all_as_read.php') ?>', true); // Ganti 'mark_all_as_read.php' dengan URL backend yang sesuai
